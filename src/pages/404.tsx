      ...
      <div className="container">
        <div className="row mb-5">
          <div className="col-12 col-lg-6 align-self-center text-center text-lg-start order-2 order-lg-1">
            <h1 className="fw-bold">Pagina non trovata</h1>
            <div className="text-center text-lg-start">
              <p
                className="fw-medium mx-auto mx-lg-0"
                style={{ maxWidth: "36ch" }}
              >
                Siamo spiacenti, questa pagina non è stata trovata o non esiste.
                Vuoi provare a cercarla?
              </p>
            </div>
